...
expwort default class GuildBanAddListenyer extends Listenyer {
  cwonstwuctwor() {
    super()
  ...
  async on(client, guild, Mwember) {
    twy {
      ...
      cwonst guildBanAdd = audit.entwies.fwilter(action => action.actionType === 22)
      ...
      embed.setTitle(_wocale('basic:punyishment.bannyed', { 0: `@${Mwember.usernyame}` }))
