...
module.exports = class HelpCommand extends Command {
	...
	run({ message, args, server }, t) {
		...
		embed.addField(`${t("commands:help.economy")} (${this.getCommmandSize("economy")})`, this.getCategory("economy", server.prefix))
		embed.addField(`${t("commands:help.fun")} (${this.getCommmandSize("fun")})`, this.getCategory("fun", server.prefix))
		embed.addField(`${t("commands:help.games")} (${this.getCommmandSize("games")})`, this.getCategory("games", server.prefix))
