...
module.exports = class BotinfoCommand extends Command {
    ...
    execute({message, args, server}, t) {
        ...
        cpuStat.usagePercent(function(err, percent, seconds) {
            ...
            .setDescription(t('commands:botinfo.description', {clientName: client.user.username, clientCreatedAt: moment.utc(client.user.createdAt).format('LLLL'), guildName: message.guild.name, clientUptime: moment.duration(client.uptime).format('D[d], H[h], m[m], s[s]'), clientGuildSize: client.guilds.size, clientUserSize: client.users.size, clientJoinedAt: moment.utc(message.guild.me.joinedAt).format('LLLL')}))
