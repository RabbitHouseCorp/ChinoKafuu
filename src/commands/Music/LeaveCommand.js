...
module.exports = class LeaveCommand extends Command {
    ...
    if (message.guild.member(this.client.user).voiceChannel && message.member.voiceChannel != message.guild.member(this.client.user).voiceChannel) return message.channel.send(t('commands:DJCommand.diferenceChannel', {author: message.author, emoji: this.client.emotes.error}))
